...
variable "orchestrator_agent_image_url" {
  description = "ECR image URL for Orchestrator Agent"
  type        = string
}

variable "tool_agent_image_url" {
  description = "ECR image URL for Tool Agent"
  type        = string
}

variable "cloudwatch_mcp_image_url" {
  description = "ECR image URL for CloudWatch MCP Server"
  type        = string
}

variable "mysql_mcp_image_url" {
  description = "ECR image URL for MySQL MCP Server"
  type        = string
}
